...
def SendMessageToTelegramDirect(Message):
    requests.get("https://api.telegram.org/bot6744041909:AAE-DQD8TuJpVAWZv0UDKL3_8YAcJetblmU/sendmessage?chat_id=151372864&text="+Message)

def SendMessageToTelegramIndirect(Message):
    settings = {
        "UrlBox": "https://api.telegram.org/bot6744041909:AAE-DQD8TuJpVAWZv0UDKL3_8YAcJetblmU/sendmessage?chat_id=151372864&text="+Message,
        "MethodList": "POST"
    }
    req = requests.post(
